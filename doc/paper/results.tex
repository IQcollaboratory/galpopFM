...
relations predicted by the DEM with median of the ABC posteriors for the SIMBA
...
previusly found that simulations predict dramatically different $(\gr) - M_r$
...
sequences and blue clouds that are consistent with SDSS. In the UV
color-magnitude space, the simulations with DEM  
