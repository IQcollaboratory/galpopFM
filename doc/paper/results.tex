...
\chedit{ 
    ...
    In addition to the overall shift in color, the simulations also predict optically blue
    luminous galaxies with $M_r < -21.5$ that are not found in the
    observations; this is particularly noticeable for SIMBA and TNG. 
...
The \eda~affects the the optical and UV color-magnitude relations in three
major ways to produce good agreement with SDSS. 
\chedit{
    First, the \eda~significantly reddens simulated galaxies in the optical. 
    Overall, the $\gr$ colors are ${\gtrsim}0.25~mag$ redder than the optical
...
\begin{center}
    ...
    \chedit{
        ...
        The top and center panels mark the luminous UV red and other $M_r < -22$
        ...
        galaxies. 
        \emph{Therefore, SIMBA and TNG pedict luminous UV red galaxies because 
        their prescription for star formation quenchign is too efficient for the most
        massive galaxies.}
    }
    }
\end{center}
...
\chedit{
    ...
    They are present in the UV color-magnitude predictions even without dust
    attenuation~(Figure~\ref{fig:obs}). 
    Since these galaxies are luminous and they have intrinsic $fnuv > 2$, 
    dust attenuation, even beyond the \eda, cannot remove them from the
    UV color-magnitude relation.  
}

\chedit{ 
    In order to understand the origin of the luminous red galaxies in SIMBA and
    TNG, we examine their star formation histories in Figure~\ref{fig:uv_sfh}.
    The top and center panels marks the luminous UV red galaxies on the optical
    and UV color-magnitude relations predicted by the \eda. 
    ...
    Luminous UV red galaxies of SIMBA and TNG have little star formation 
    within the last $t_{\rm lookback} {\lesssim}2$ Gyr and peak their star 
    formation at $z > 2$.
    For comparison, we include the SSFHs of other galaxies with matching
    luminosities, $M_r < -22$ (orange),
    These matching galaxies are also quiescent, but unlike the luminous UV red
    galaxies they have some recent star formation. 
    This suggests that we find luminous UV red galaxies because \emph{star
    formation quenching is too efficient in SIMBA and TNG for the most massive
    galaxies}. 
    Besides the the lack of recent star formation, the luminous red galaxies in 
    TNG have overall similar SFHs as the other luminous quiescent galaxies. 
    In SIMBA, however, the luminous UV red galaxies have a significantly
    different SSFH than the matching quiescent galaxies with a more rapid
    decline in star formation. 
    In another paper of the IQ series (Choi et al. in prep), we examine this
    SFH difference in further detail and present its impact the quiescent 
