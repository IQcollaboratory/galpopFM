...
\chedit{ 
    ...
    Luminous UV red galaxies have negligible star formation within the last 
    $t_{\rm lookback} {\lesssim}2$ Gyr and peak their star formation at $z >
    2$.
    For comparison, we include the SSFHs of other galaxies with matching
    luminosities: $M_r < -22$ (orange).
    These galaxies are all quiescent, but unlike the luminous UV red galaxies,
    they have some recent star formation. 
