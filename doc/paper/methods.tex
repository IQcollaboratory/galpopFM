...
\begin{figure}
    \begin{center}
        ...
        \caption{Comparisons of $A_V$ distribution from slab model Eq.~\ref{eq:slab}, truncated normal model Eq.~\ref{eq:tnorm}, and SDSS SF galaxies.}
        \label{fig:dem}
    \end{center}
\end{figure}
...
\begin{table}
    ...
    \begin{center}
        \begin{tabular}{cc} \toprule
            ...
            \multicolumn{2}{c}{DEM with slab model}\\ \hline
            ...
            \hline
            \multicolumn{2}{c}{DEM with $\mathcal{N}_T$ model}\\ \hline
