...
sampling $A_V$. 
However, the~\eda~seeks to assign an accurate distribution of dust
...
based \eda~can match the observed distribution of $A_V$, even for samples that
...
We use fixed $\lambda_0 = 2175 A$ and $\Delta \lambda = 350A$. 
