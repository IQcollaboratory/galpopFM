...
were to marginalize over dust in our comparison to observations, we would be
left with little constraining power to distinguish between the different galaxy
physics prescriptions in the simulations. Current limitations in our understanding 
of dust is a major bottleneck for investigating galaxy formation using simulations.
...
\begin{center}
    ...
    IR dust emission}. Including IR observations, 
    }
\end{center}
\end{figure}
...
Spectrograph~\citep[PFS;][]{takada2014}, will also vastly expand galaxy
