...
\ch{
    ...
    This choice is loosely motivatd by the fact that the slab model reproduces
    ...
    We therefore conclude that the slab model provides a sufficiently flexible empirical
    prescription for sampling $A_V$ in our \eda.
}
...
\ch{
    ...
    Moreover, \emph{James Webb Space Telecope (JWST)} and \emph{Nancy Grace
    Roman Space Telescope} will also provide valuable IR observations.
}
