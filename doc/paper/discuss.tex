...
quiescent galaxies.
%It therefore provides sufficient flexibility for sampling $A_V$ in our \eda~prescription.
%We therefore conclude that we can sample $A_V$ in our \eda~with sufficient flexibility using the slab model. 
...
%The $M_*$ limit of the selection is lower for SIMBA due to its lack of massive galaxies and low mass starburst galaxies. 
...
In this work, we only use observables derived from UV and optical
