...
which has a comoving volume of $(100\,\mpc)^3$. % baryonic mass resolution of $1.81\times 10^6M_{\sun}$. It 
...
Next in the forward model, we use the \eda~model to assign dust attenuation
