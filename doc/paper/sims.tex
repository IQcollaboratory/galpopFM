...
Type I supernovae and AGB stars. {\sc Simba} adds a two-mode SMBH accretion 
...
\includegraphics[width=0.45\textwidth]{figs/sdss_selection.pdf} 
    ...
    \chedit{
        We derive our magnitude limited observational sample (blue) from the
        SDSS DR7 NYU-VAGC (black dashed). 
        We impose $M_r < -20$, $M_{FUV} < -13.5$  and $M_{NUV} < -14.0$
        completeness limits. 
        We describe the galaxy sample and completess limits in more detail in
        Section~\ref{sec:obs}. 
...
\chedit{
    ...
    We include the original SDSS NYU-VAGC (black dash) for comparison.
