...
Observational aperture effects also affect the SMF, in particular at the higher mass end where a significant fraction of the theoretical total stellar mass 
exists at large radii that are not included in observational apertures. For a proper comparison aperture effects should be taken into account \citep[see also][]{schaye2015, pillepich2018}.
}
