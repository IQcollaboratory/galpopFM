...
\begin{center}
    ...
    \chedit{ 
        ...
        attenuation \tks{at constant SSFR} --- consistent with the literature.
...
simulations in black dashed contours \tks{Daniel's comment: please indicate percentiles that correspond to the black contours}.

In each panel, we find that SIMBA, TNG, and EAGLE galaxies with higher
$M_*$ have higher dust attenuation \tks{at constant SSFR} --- consistent with the literature.
