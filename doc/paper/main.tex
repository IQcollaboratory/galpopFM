...
\begin{abstract}
    ...
    Using the \eda, we forward model synthetic observations for a $M_r < -20$
    complete galaxy sample for three state-of-the-art large-scale cosmological
    hydrodynamical simulations: SIMBA, IllustrisTNG, and EAGLE.  We then
    compare the optical
    ...
    inference. 
    Without dust, none of the simulations can match observations as expected.
    ...
    \chedit{
        Furthermore, this work illustrates a major limitation in comparing galaxy
        formation models: by adjusting dust attenation alone, simulations with
        significantly different galaxy populations can reproduce the same UV
        and optical observations. 
    }
    %Furthermore, this work demonstrates that dust attenuation is highly degenerate with differences among galaxy physics prescriptions.
