...
\begin{abstract}
    ...
    dust cannot fix because the simulations quench star formation too
    efficiently in the most massive galaxies. 
    ...
    with lower amplitude than star-forming galaixes.
