...
\begin{abstract}
    ...
    \chedit{
        ...
        For SIMBA and TNG, we find an excess of luminous UV red galaxies that
        dust cannot fix because they quench star formation too efficiently
        for the most massive galaxies. 
    }
    %We find that we can accurately reproduce the color-magnitude relations of the observational sample for TNG and EAGLE. For SIMBA, we struggle to reproduce observations due to its overprediction of luminous low-mass galaxies with high star-formation rates.
    Examining the attenuation curves predicted by our dust prescription, we
    find good agreement with observed attenuation--slope relations and
    attenuation curves of star-forming galaxies. 
    \chedit{
        Although, the \eda~does not predict star-forming galaxies with low
    ...
    \chedit{
        The simulated quiescent galaxies require shallower attenuation curves
        and lower dust attenuation than star-forming galaixes.
        }
    Overall, we find that more massive galaxies in the simulations require
    higher dust attenuation, while galaxies with higher specific star formation
    rates have steeper attenuation curves.
    \chedit{
    ...
    %In addition to improving our understanding of dust in galaxies and shedding light on hydrodynamical simulations, our results underscore the advantages of \eda~and the forward modeling approach. 
