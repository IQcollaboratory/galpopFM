...
#python ~/projects/galpopFM/run/plot_abc.py True $dem 11 11 $sfr0 
...
#python ~/projects/galpopFM/run/plot_abc.py True $dem 12 12 $sfr0
...
python ~/projects/galpopFM/run/plot_abc.py True $dem 1 1 $sfr0 
