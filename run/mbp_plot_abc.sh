...
python ~/projects/galpopFM/run/plot_abc.py True $dem 0 13 $sfr0 
...
python ~/projects/galpopFM/run/plot_abc.py True $dem 0 25 $sfr0
...
python ~/projects/galpopFM/run/plot_abc.py True $dem 0 27 $sfr0 
