...
python ~/projects/galpopFM/run/plot_abc.py True $dem 26 28 $sfr0 
...
python ~/projects/galpopFM/run/plot_abc.py True $dem 25 26 $sfr0
...
python ~/projects/galpopFM/run/plot_abc.py True $dem 27 28 $sfr0 
