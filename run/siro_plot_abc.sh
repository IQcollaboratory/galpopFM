...
#python ~/projects/galpopFM/run/plot_abc.py False $dem 12 13 sfrmin
...
#python ~/projects/galpopFM/run/plot_abc.py True $dem 19 22 sfrmin
...
python ~/projects/galpopFM/run/plot_abc.py False $dem 1 3 $sfr0 
